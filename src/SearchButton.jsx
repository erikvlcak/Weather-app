...
export default function SearchButton({
  ...
  return (
    <button
      ...
      className="select-none h-full w-full rounded-xl border-4 text-2xl px-10 py-2 font-bold relative flex items-center justify-center overflow-hidden bg-[#9C1347] text-white shadow-2xl md:transition-all before:absolute before:h-0 before:w-0 md:before:rounded-full before:bg-[#d25a88] md:before:duration-500 md:before:ease-out md:hover:shadow-[#FFAFCC] md:before:h-56 md:hover:before:w-56"
    >
